...
function renderNodeSettings(section, data, features, main_node, routing_mode) {
	...
	o = ss.option(form.MultiValue, 'outbounds', _('Outbounds'),
		_('choose outbounds.'));
	...
	o.modalonly = true;
	o = ss.option(form.Value, 'url', _('Test URL'),
	...
	o.depends('type', 'urltest');
	o.modalonly = true;
	o = ss.option(form.Value, 'idle_timeout', _('Idle timeout'),
		_('The idle timeout. 30m will be used if empty.'));
	o.depends('type', 'urltest');
	o.modalonly = true;
	o = ss.option(form.ListValue, 'default', _('Default outbound'),
	...
	o.depends('type', 'selector');
	o.modalonly = true;
	o = ss.option(form.Flag, 'interrupt_exist_connections', _('Interrupt exist connections'),
